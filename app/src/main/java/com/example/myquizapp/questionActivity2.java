...
public class questionActivity2 extends AppCompatActivity implements View.OnClickListener{
    ...
    private void loadNewQuestion(){
        ...
        questionTextView.setText(QuestionAnswer.question2[currentQuestionIndex]);
        ansA.setText(QuestionAnswer.choicess2[currentQuestionIndex][0]);
        ansB.setText(QuestionAnswer.choicess2[currentQuestionIndex][1]);
        ansC.setText(QuestionAnswer.choicess2[currentQuestionIndex][2]);
        ansD.setText(QuestionAnswer.choicess2[currentQuestionIndex][3]);
    ...
    public void onClick(View view) {
        ...
        if (clickedButton.getId() == R.id.btn_submit) {
            if (!selectedAnswer.isEmpty()) {
                if (selectedAnswer.equals(QuestionAnswer.correctAnswerss2[currentQuestionIndex])) {
                    score++;
                    new StyleableToast
                            .Builder(questionActivity2.this)
                            .text("Correct Answer!")
